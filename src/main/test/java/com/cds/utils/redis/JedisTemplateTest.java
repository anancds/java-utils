...
public class JedisTemplateTest {
    ...
    @ClassRule
    public static EmbeddedRedis embeddedRedisRule = EmbeddedRedis.EmbeddedRedisRuleBuilder.newEmbeddedRedisRule().build();
    ...
    public void stringActions() {
        ...
        System.out.println(jedisTemplate.get(notExistKey));
        System.out.println("tet " + jedisTemplate.get(notExistKey));
    ...
    public void setAction(){
        String key1="test.set.key1";
        String key2="test.set.key2";
        String member = "abc";
        String member2 = "def";
        String member3 = "ghi";


        assertThat(jedisTemplate.sadd(key1,member)).isTrue();
        assertThat(jedisTemplate.sadd(key1,member2)).isTrue();
        assertThat(jedisTemplate.sadd(key2,member2)).isTrue();
        assertThat(jedisTemplate.sadd(key2,member3)).isTrue();

        assertThat(jedisTemplate.smembers(key1)).contains(member,member2);

//        assertThat(jedisTemplate.get(key2)).contains(member);
    }
}
