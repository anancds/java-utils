package com.cds.utils.xml;

import com.cds.utils.StringUtils;
import com.cds.utils.URLUtils;
import org.dom4j.*;
...
/**
 * XML Document 工具类,使用Dom4j
 */
public class XMLDocUtils {

    /**
     * 根据xml文件来创建xml document
     * @param file
     * @return
     */
    public static Document createDocByAbsolutePath(String file) {
        ...
        try {
            ...
            throw new RuntimeException("Read xml file failed:" + file, e);
        }
    }

    public static Document createDoc(String uri) {
        URL fileUrl = URLUtils.getResourceFileUrl(uri);
        if (fileUrl == null) {
            throw new RuntimeException("not find the file:" + uri);
        }
        ...
        try {
            ...
            throw new RuntimeException("read file failed:" + fileUrl, e);
        }
    }
    public static Document dataXml2Doc(String dataXml) {
        if(!StringUtils.hasLength(dataXml)) return null;
        ...
        try {
            ...
            throw new RuntimeException("dataXml to doc failed:", e);
        }
        return doc;
    }
