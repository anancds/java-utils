...
import com.cds.utils.redis.JedisTemplate;
import com.cds.utils.redis.JedisUtils;
...
@SuppressWarnings("unused") public class JedisSentinelPool extends JedisPool {
    ...
    List<JedisPool> sentinelPools = new ArrayList<>();
    ...
    public JedisSentinelPool(String poolName, HostAndPort[] sentinelAddresses, String masterName,
        ...
        // sentinelAddresses
        assertArgument(((sentinelAddresses == null) || (sentinelAddresses.length == 0)),
            "seintinelInfos is not set");

        for (HostAndPort sentinelAddress : sentinelAddresses) {
            JedisPool sentinelPool =
                new JedisDirectPool(poolName + "-sentinel", sentinelAddress, new JedisPoolConfig());
    ...
    public class MasterSwitchListener extends Thread {
            ...
            while (running.get()) {
                try {
                    ...
                    if (sentinelPool != null) {
                        ...
                        sentinelJedis
                            .subscribe(subscriber, "+switch-master", "+redirect-to-master");
                    } else {
                        logger
                            .info("All sentinels down, sleep 2 seconds and try to connect again.");
        ...
        private HostAndPort queryMasterAddress() {
            ...
            List<String> address =
                sentinelTemplate.execute(new JedisTemplate.JedisAction<List<String>>() {
            ...
            if ((address == null) || address.isEmpty()) {
                throw new IllegalArgumentException(
                    "Master name " + masterName + " is not in sentinel.conf");
            }
            ...
            @Override public void onMessage(String channel, String message) {
                ...
                if (masterName.equals(switchMasterMsg[0])) {
                    ...
                    HostAndPort masterAddress =
                        new HostAndPort(switchMasterMsg[3], Integer.parseInt(switchMasterMsg[4]));
