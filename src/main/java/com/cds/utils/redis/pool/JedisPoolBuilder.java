...
public class JedisPoolBuilder {
    ...
    private JedisPool buildDirectPool(String hostAndPort, ConnectionInfo connectionInfo,
    ...
    private JedisPool buildSentinelPool(String masterName, ConnectionInfo connectionInfo,
                                        JedisPoolConfig config) {
        logger.info("Building JedisSentinelPool, on sentinel sentinelHosts:" + Arrays
                .toString(sentinelHostAndPorts) + ", masterName is " + masterName);
        ...
        return new JedisSentinelPool(poolName, sentinelAddresses, masterName, connectionInfo,
                config);
    }
