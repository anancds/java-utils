package com.cds.utils.common.serializer

import java.io.{Closeable, EOFException, InputStream, OutputStream}
import java.nio.ByteBuffer
import javax.annotation.concurrent.NotThreadSafe

import com.cds.utils.common.NextIterator
import com.cds.utils.common.annotation.{DeveloperApi, Private}
...
abstract class Serializer {
  ...
  /**
    ...
    */
  @Private
  private[common] def supportsRelocationOfSerializedObjects: Boolean = false
}
